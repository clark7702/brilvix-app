...
export default function Hero() {
  ...
  return (
    <section id="home" className="pt-28 pb-20 md:pt-40 md:pb-28 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            <h1 className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl mb-6 leading-tight">
              Crafting <span className="text-primary">Digital Experiences</span> That Define Brands
            </h1>
            <p className="text-gray-600 text-lg mb-8 max-w-lg">
              Brilvix delivers innovative media solutions that transform how Canadian brands connect with their audience in the digital landscape.
            </p>
            ...
            >
              ...
              <div className="absolute -bottom-5 -right-5 bg-white p-4 rounded-xl shadow-lg">
                <div className="flex items-center gap-4 p-2">
                  ...
                  <span className="font-medium">Creating the future of media</span>
                </div>
              </div>
            </motion.div>
          </motion.div>
